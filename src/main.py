...
from data_etl.stations import load_stations, ingest_stations
from data_etl.climate_history import load_climate_history, ingest_climate_history
...
def main():
    ...
    parser.add_argument(
        "--stations-file",
        default="data/tables/stations_db.txt",
        help="Path to stations list txt file",
    )
    parser.add_argument(
        "--es-creds-file",
        default="config/creds.json",
        help="Path to the ElasticSearch Cluster credentials file",
    )
    parser.add_argument(
